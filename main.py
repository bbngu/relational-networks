...
parser = argparse.ArgumentParser(
    description="PyTorch Relational-Network sort-of-CLVR Example"
)
parser.add_argument(
    "--model",
    type=str,
...
def train(epoch, rel, norel):
    ...
    for batch_idx in range(len(rel[0]) // bs):
        ...
        if batch_idx % args.log_interval == 0:
            accuracy = (accuracy_norel + accuracy_rel) / 2.0
            log_dict = {
                "accuracy_rel": accuracy_rel,
                "accuracy_norel": accuracy_norel,
                "accuracy": accuracy,
            }
